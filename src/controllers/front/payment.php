...
class AdyenOfficialPaymentModuleFrontController extends PaymentController
{
    ...
    public function postProcess()
    {
        ...
        $giftCardsData = SessionService::get('giftCardsData', false);
        $giftCardsData = is_array($giftCardsData) ? $giftCardsData : [];
        ...
        if ($customerEmail !== '') {
            ...
            $payPalGuestExpressCheckoutService
                ->startGuestPayPalPaymentTransaction($cart, $this->getOrderTotal($cart, $type), $data, $giftCardsData);
        }
