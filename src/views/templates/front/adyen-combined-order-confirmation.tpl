{if !empty($adyenAction)}
    <div class="row">
        ...
        <div id="adyen-additional-action" style="display: none;" type="text/html">{$adyenAction|escape:'html':'UTF-8'}</div>
    ...
    <div class="card-block">
        <div class="row" style="width: 70%; margin-left: 150px">
            <div id='donation-container'
                 data-donationsConfigUrl="{$donationsConfigUrl|escape:'htmlall':'UTF-8'}"
                 data-makeDonationsUrl="{$makeDonationsUrl|escape:'htmlall':'UTF-8'}"
            ></div>
        </div>
    </div>
{/if}
